...
public class Eliminacion_Clientes extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                Eliminacion_Clientes frame = new Eliminacion_Clientes();
    ...
    public Eliminacion_Clientes() {
        ...
        JLabel lblTitle = new JLabel("ELIMINAR CLIENTE");
        ...
        scrollPane.setBounds(200, 280, 400, 150);
        ...
        btnEliminar.setBounds(320, 450, 150, 40);
