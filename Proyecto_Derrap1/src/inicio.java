...
public class inicio extends JFrame {
	...
	public inicio() {
		...
		jl1.setBounds(150, 10, 500, 70);  // Tamaño más grande y centrado
		contentPane.add(jl1);
		 ...
		 btnAceptar.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		            ...
		            String query = "SELECT rol FROM Usuarios WHERE dni='" + dni + "' AND contraseña='" + password + "'";
		            ...
		            if (resultado.next()) {
		                ...
		                if (rol == 0) {
		                    ...
		                    // Abre la pestaña o ventana del administrador
		                    // Ejemplo: new AdministradorFrame().setVisible(true);
		                    new Dashboard_administrador().setVisible(true);
		                } else if (rol == 1) {
		                    JOptionPane.showMessageDialog(contentPane, "Bienvenido a la pestaña de Mecanico");
		                    // Abre la pestaña o ventana del usuario normal
		                    // Ejemplo: new UsuarioFrame().setVisible(true);
		                    
		                    new Dashboard_mecanico().setVisible(true);
	        ...
	        btnAceptar.setBounds(350, 320, 100, 40);  // Posicionamiento del botón debajo del área de inicio de sesión
